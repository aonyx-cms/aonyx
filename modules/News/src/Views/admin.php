...
{
    $news = new \Modules\News\Models\NewsEntity(
        [
            'auteur' => $_POST['auteur'],
            'titre' => $_POST['titre'],
...
<p><a href="index.php?module=news">Retour au module de news</a></p>



<form action="index.php?module=news&action=admin" method="post">
