    ...
    <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a href="<?php echo $config->referer(); ?>/news">News</a></li>
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="<?php echo $config->referer(); ?>/members">Accueil</a></li>
                        <li><a href="<?php echo $config->referer(); ?>/members/profile">Profil</a></li>
                        <li><a href="<?php echo $config->referer(); ?>/members/logout">Déconnexion</a></li>
                    </ul>
                </li>
            </ul>
        </div><!--/.nav-collapse -->
